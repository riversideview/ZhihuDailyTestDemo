...
typedef enum {
    SDCycleScrollViewPageControlAlignmentRight,
    SDCycleScrollViewPageControlAlignmentCenter
} SDCycleScrollViewPageControlAlignment;
...
// 分页控件位置
@property (nonatomic, assign) SDCycleScrollViewPageControlAlignment pageControlAlignment;
