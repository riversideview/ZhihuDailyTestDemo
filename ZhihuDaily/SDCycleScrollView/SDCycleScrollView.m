...
- (void)initialization
{
    _pageControlAlignment = SDCycleScrollViewPageControlAlignmentCenter;
...
- (void)setupMainView
{
    ...
    [mainView registerClass:NSClassFromString(@"SDCollectionViewCell") forCellWithReuseIdentifier:ID];
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAlignment == SDCycleScrollViewPageControlAlignmentRight) {
...
//    NSLog(@"indexPathitem = %li",(long)indexPath.item);
//    NSLog(@"imagesGroup = %lu", (unsigned long)self.imagesGroup.count);
//    NSLog(@"itemIndex = %li", itemIndex);
