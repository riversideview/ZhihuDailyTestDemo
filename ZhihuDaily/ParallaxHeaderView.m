...
//        self.clipsToBounds = YES;
        ...
        [self.delegate lockContentOffsetTopY];
    }
    else
    {
        CGFloat delta = 0.0f;
...
- (void)initialSetupForCustomSubView:(UIView *)subView
{
    ...
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(self.frame.origin.x, 0, self.frame.size.width, self.frame.size.height)];
